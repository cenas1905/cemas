...
const faqs = [
  ...
  { q: 'AI optimizasyon gerçekten fark yaratıyor mu?', a: 'Evet. Claude 3.5 Sonnet modelimiz CV\'nizi ATS (Applicant Tracking System) kriterlerine göre analiz eder, başarıları ölçülebilir hale getirir ve hedef şirketin değerlerine uygun dil kullanır. Kullanıcılarımızın %94\'ü mülakat daveti almaktadır.' },
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <motion.div initial={{ opacity:0, y:16 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.5 }}>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold border"
              ...
              Claude 3.5 Sonnet + Apify ile Güçlendirildi
            </span>
          </motion.div>
          ...
          <motion.p initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.6, delay:0.2 }}
            ...
            <br className="hidden sm:block" /> bir sonraki mülakat davetinizi garantileyın.
          </motion.p>
          ...
          <div className="relative rounded-2xl overflow-hidden border border-white/8 shadow-2xl"
            ...
            <div className="p-8">
              ...
              <div className="space-y-3">
                {[
                  { title:'Google — Senior Frontend Engineer', tag:'AI Optimize', views:523, active:true },
                  { title:'Trendyol — Lead Developer', tag:'Pro Link', views:412, active:true },
              ...
              <div className="mt-5 flex items-center gap-3 p-4 rounded-xl border border-indigo-500/20" style={{ background:'rgba(99,102,241,0.06)' }}>
                ...
                <p className="text-sm text-indigo-300"><span className="font-bold">AI Koç:</span> Google mülakatında sistem tasarımı sorularına hazırlan. FAANG sorularını çalışalım mı?</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <section id="nasil-calisir" className="relative z-10 py-28 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-black tracking-tight">3 adımda iş bulun</h2>
          </div>
      ...
      <section id="ozellikler" className="relative z-10 py-24 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { emoji:'🔗', title:'LinkedIn\'den Tek Tıkla Import', desc:'Profil linkinizi yapıştırın; Apify scraper tüm verilerinizi otomatik çeker. 30 saniye.', tag:'En çok sevilen' },
              { emoji:'🤖', title:'Claude AI Optimizasyon', desc:'Şirkete özel anahtar kelimeler, ölçülebilir başarılar, güçlü fiiller. ATS geçer garantisi.', tag:'AI destekli' },
              { emoji:'🔒', title:'Kalıcı Paylaşım Linki', desc:'cvio.app/cv/adınız-şirket — asla sona ermeyen, takip edilebilir özel link.', tag:'Pro' },
              { emoji:'🧠', title:'AI Kariyer Koçu', desc:'CV\'nizi bilen kişisel koçunuz. Mülakat, müzakere, sektör tavsiyeleri — sınırsız.', tag:'Pro' },
              { emoji:'📊', title:'Görüntülenme Analitiği', desc:'Kim baktı, ne zaman, kaç kez? Gerçek zamanlı link izleme panosu.', tag:'Pro' },
              { emoji:'📄', title:'Anında PDF İndirme', desc:'Profesyonel ATS uyumlu şablonlardan seçin, tek tıkla A4 PDF oluşturun.', tag:'Tüm planlar' },
            ].map((f,i) => (
      ...
      <section id="fiyatlar" className="relative z-10 py-24 px-4 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-black tracking-tight">Bir mülakat daveti<br /><span className="gradient-text">her şeye değer</span></h2>
            <p className="text-slate-400 mt-4 text-lg">Gizli ücret yok. İstediğiniz zaman iptal.</p>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden px-8 py-16 space-y-6 border border-indigo-500/20"
            ...
            <div className="relative">
              ...
              <p className="text-slate-400 text-lg mb-8 max-w-lg mx-auto">
                60 saniyede oluşturun, şirkete özel link paylaşın, gerçek zamanlı takip edin.
              </p>
              <Link href="/register">
